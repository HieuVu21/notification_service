export { IAuth, IAuthPayload, IAuthDocument, IAuthBuyerMessageDetails, IEmailMessageDetails, ISignUpPayload, ISignInPayload, IForgotPassword, IResetPassword, IReduxAuthPayload, IReduxAddAuthUser, IReduxLogout, IAuthResponse, IAuthUser } from './auth.interface';
...
export { IErrorResponse, IError, customError, BadRequestError, NotFoundError, NotAuthorizeError, FileTooLargeError, ServerError } from './error-handler';
